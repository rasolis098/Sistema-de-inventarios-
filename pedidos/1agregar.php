...
<body>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 text-muted">Complete la informaci車n para crear un nuevo pedido</p>
                </div>
        ...
        <form action="guardar_pedido.php" method="POST" id="formPedido">
            <div class="form-container">
                ...
                <div class="form-section">
                    <h3 class="section-title"><i class="fas fa-user"></i>Informaci車n del Cliente</h3>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="productos[0][nombre]" class="form-control producto-autocomplete" 
                                           placeholder="Escribe c車digo o nombre del producto" required>
                                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <label class="form-label">Informaci車n adicional</label>
                            <textarea name="observaciones" class="form-control" rows="4" 
                                      placeholder="Agregue cualquier observaci車n o instrucci車n especial para este pedido..."></textarea>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $("#formPedido").on("submit", function(e) {
            ...
            if (!hasValidProducts) {
                e.preventDefault();
                alert("Debe agregar al menos un producto v芍lido al pedido.");
                return false;
            }
